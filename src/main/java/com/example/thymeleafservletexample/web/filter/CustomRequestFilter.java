 ...
 * =============================================================================
 */
package com.example.thymeleafservletexample.web.filter;

import java.io.IOException;
import java.io.Writer;

import com.example.thymeleafservletexample.domain.entities.User;
import com.example.thymeleafservletexample.web.controller.Controller;
import com.example.thymeleafservletexample.web.mapping.ControllerMappings;
...
public class CustomRequestFilter implements Filter {
    ...
    private boolean process(final HttpServletRequest request, final HttpServletResponse response) throws ServletException {
        try {
             ...
             */
            final Controller controller = ControllerMappings.resolveController(webRequest);
            if (controller == null) {
                return false;
            }
